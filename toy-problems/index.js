...
const isPrime = function (input) {
  ...
  const maxDivisor = Math.floor(input / 2);
...
const nameVowels = function () {
  // your code here:  using 'data', this function should return the number of
  // animals who's name contains more than 3 vowels (for simplicity, do not consider "y" a vowel)
};
...
const palindromes = function (input) {
  // your code here:  this function accepts one string 'input' and
  // should return true if the string is a palindrome and false if it is not
};
